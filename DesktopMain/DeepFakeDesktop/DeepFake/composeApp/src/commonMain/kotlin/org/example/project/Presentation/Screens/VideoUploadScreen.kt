...
fun VideoUploadScreen(
    ...
    // 📦 Observe state
    val uploadState by viewModel.uploadDeepFakeVideoState.collectAsState()
    ...
    val launcher = rememberFilePickerLauncher(
        ...
        file?.let {
            scope.launch {
                ...
                viewModel.uploadVideoToDeepFakeServer(bytes)
            }
        }
    }
    ...
    Box(
        ...
        Card(
            ...
            colors = CardDefaults.cardColors(containerColor = Color(color = 0xFFFFFFFF)),
