...
function App() {
    ...
    // Function to fetch visual analysis images
    const fetchVisualAnalysis = async () => {
        try {
            ...
            // Processing the Grad-CAM heatmap
            ...
            alert("Error retrieving visual analysis. Please try again.");
        }
    };
